...
const Dashboard: React.FC = () => {
  ...
  if ((userLoading && !isTelegram) || tasksLoading) {
    return (
      <div className="min-h-screen bg-[#12243B] text-white">
        <Header />
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-center items-center h-64">
            <div className="text-center">
              <p className="text-white">Loading airdrop data...</p>
            </div>
          </div>
        </main>
        <Footer />
  ...
  return (
    <div className="min-h-screen bg-[#12243B] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {isTelegram && (
          <div className="mb-4 bg-blue-900/30 border border-blue-800 rounded-lg p-3 flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-[#1c3252] rounded-xl shadow-sm overflow-hidden border border-[#2a4365]">
              <CardHeader className="border-b border-[#2a4365] p-4 flex justify-between items-center">
                <h3 className="font-semibold text-lg text-white">Required Tasks</h3>
                <span className="text-xs text-blue-200">Earn GLRS Tokens</span>
              </CardHeader>
              
              <CardContent className="p-0 divide-y divide-[#2a4365]">
